              ...
              <ul class="postalInfoDiv">
                ...
                <li>
                  ...
                  <p
                    ...
                    :content="CB_PAYMENT"
                  >
                    Payment by credit card 💳{{ is_CB_accepted }}
                  </p>
                </li>
                <li>
                  <span class="icon has-text">
        ...
        <div class="columns">
          <div class="column" style="">
            ...
            >
              ...
              "
                ...
                <input
                  ...
                  placeholder="Add Youtube video embed code:"
                />
            ...
            <div v-if="videoIntegrationCode" class="card">
              <p class="description">{{ companyName }} How it works ?</p>
    ...
    this.$axios
      ...
      .then(async result => {
        ...
        if (this.ZIP_CODE.match("^69")) {
          ...
          this.companyName = `The Bike`;
          this.companyDesc = `The Bike designates a system of self-service bicycles set up in the metropolis of Lyon and managed by the company JCDecaux since May 19, 2005. This is the name under which JCDecaux operates its Cyclocity system in Lyon and Villeurbanne.`;
        }
        //sainte
          ...
          this.companyName = "The VéliVert";
          this.companyDesc = `Mobility complementary to public transport is thus offered.
                 Many cycle paths are available in the agglomeration.
                 You can also use bus lanes.
                 A padlock is included in the bike.
                 All you have to do is pedal...
                 Do not hesitate any longer and set off to conquer the territory in the company of your mobility and tourism partners!`;
        } else {
