    ...
    >
      <b-step-item label="Example fichier.json" :clickable="isStepsClickable">
        ...
        <div class="container1">
          <b-tooltip
            label="Example of the Json file to provide!"
            type="is-dark"
            always
          >
            <img
          ...
          <b-tooltip
            label="Description of the Json file to provide!"
            type="is-dark"
            always
          >
            <img
        ...
        <b-field  label="Add link to data source: (JSON)">
    ...
    async changedStep(index) {
      if (index == 1) {
        try {
          ...
          setTimeout(() => {
            this.$buefy.snackbar.open({
              message: "Please check the link entered!",
              type: "is-warning",
              position: "is-top"
            });
            this.activeStep -= 1;
      ...
      if (index == 2) {
        if (this.notified) {
          ...
          console.log("oups !");
          this.$buefy.snackbar.open({
            message: "Please complete all columns!",
            type: "is-warning",
            position: "is-top"
          });
          setTimeout(() => {
