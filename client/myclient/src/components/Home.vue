        ...
        <div class="map animated fadeInRight">
          <div class="searchInput" v-if="!isInputDisabled">
            <input
              ...
              type="text"
              placeholder="Find Station by Name"
              v-model="stationTemp"
  ...
  methods: {
    ...
    async deleteItem(event, index) {
      this.$buefy.dialog.confirm({
        title: "City deletion",
        message: `Are you sure you want to delete the city of ${this.cities[
          index
        ].toUpperCase()} ?`,
        ...
        onConfirm: () => {
          ...
          this.$buefy.toast.open("City deleted!");
          setTimeout(() => {
    ...
    async addCity(cityName) {
      ...
      if (this.cities.indexOf(cityName) == -1) {
        ...
        if (cityItem.length > 0) {
          ...
          setTimeout(() => {
            ...
            this.$buefy.snackbar.open(
              `${cityName.toUpperCase()} is successfully added!`
            );
          }, 500);
        } else {
          this.isHidden = true;
          setTimeout(() => {
            loadingComponent.close();
            this.$buefy.snackbar.open({
              message: `${cityName.toUpperCase()} is not yet supported🥺`,
              type: "is-warning",
              position: "is-top",
              actionText: "Add city ",
              duration: 5000,
        ...
        this.$buefy.snackbar.open(
          `${cityName.toUpperCase()}Is already in the list of cities!`
        );
      }
    },
    async selected(Name) {
